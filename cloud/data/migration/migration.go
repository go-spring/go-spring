...
//
// Maturity note: only a gorm store exists today (starter-migration-gorm); the
// multi-store contract has not been verified against a second store.
//
...
// [go-spring.org/cloud/experimental/lock]'s Locker seam.
