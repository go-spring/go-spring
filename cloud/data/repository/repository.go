...
//
// Maturity note: only a gorm backend exists today (starter-repository-gorm);
// the multi-store contract has not been verified against a second store.
//
...
//
// The layering mirrors [go-spring.org/cloud/data/cache] and
...
// bean-type swap — the same choice [go-spring.org/cloud/experimental/batch].JobRepository
// makes.
