...
func TestTypeName(t *testing.T) {
	...
	data := map[reflect.Type]struct {
		...
		reflect.TypeOf(new(pkg1.SamePkg)):          {"github.com/go-spring/spring-base/util/testdata/pkg/bar/pkg.SamePkg", "*pkg.SamePkg"},
		...
		reflect.TypeOf(new(pkg2.SamePkg)):          {"github.com/go-spring/spring-base/util/testdata/pkg/foo/pkg.SamePkg", "*pkg.SamePkg"},
		...
		reflect.TypeOf(new(SamePkg)):          {"github.com/go-spring/spring-base/util/util_test.SamePkg", "*util_test.SamePkg"},
