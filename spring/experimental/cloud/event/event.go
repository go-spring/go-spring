...
// restraint of [go-spring.org/spring/experimental/aspect] (the type-safe interceptor chain)
...
// [go-spring.org/spring/health.Indicator] uses) and a small registrar calls
