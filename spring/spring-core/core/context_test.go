...
func TestApplicationContext_GetBean(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		err = ctx.GetBean(&grouper, "*core_test.BeanTwo")
		assert.Nil(t, err)
		...
		err = ctx.GetBean(&two, "github.com/go-spring/spring-core/core_test/core_test.BeanTwo:*core_test.BeanTwo")
		assert.Nil(t, err)

		err = ctx.GetBean(&grouper, "github.com/go-spring/spring-core/core_test/core_test.BeanTwo:*core_test.BeanTwo")
		assert.Nil(t, err)
...
func TestApplicationContext_RegisterMethodBean(t *testing.T) {
	...
	t.Run("method bean wire to other bean", func(t *testing.T) {
		...
		ctx.Factory(ServerInterface.Consumer, parent.BeanId()).DependsOn("core_test.ServerInterface")
