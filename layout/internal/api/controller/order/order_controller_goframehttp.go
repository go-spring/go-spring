...
// by file suffix (order_controller_<proto>.go). This file is the goframe HTTP
...
// GoframeHttpOrderController adapts goframe HTTP order rpcs to the order
...
// types.
type GoframeHttpOrderController struct {
...
func (c *GoframeHttpOrderController) CreateOrder(ctx context.Context, req *pb.CreateOrderReq) (*pb.OrderResp, error) {
	o, err := c.OrderService.CreateOrder(converter.FromGoframeHttpCreateOrderReq(req))
	if err != nil {
		return &pb.OrderResp{Code: 1, Message: err.Error()}, nil
	}
	return &pb.OrderResp{Code: 0, Message: "ok", Data: converter.ToGoframeHttpOrder(o)}, nil
}

// PayOrder handles the payment rpc for an order.
func (c *GoframeHttpOrderController) PayOrder(ctx context.Context, req *pb.PayOrderReq) (*pb.OrderResp, error) {
...
func (c *GoframeHttpOrderController) ShipOrder(ctx context.Context, req *pb.ShipOrderReq) (*pb.OrderResp, error) {
