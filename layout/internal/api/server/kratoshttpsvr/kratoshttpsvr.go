// Package kratoshttpsvr bootstraps the kratos-HTTP server and binds it to the
...
package kratoshttpsvr

import (
	"context"

	"GS_PROJECT_MODULE/idl/kratos-http/pb"
	"GS_PROJECT_MODULE/internal/api/server/kratoshttpsvr/middleware"
