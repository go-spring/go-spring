// Package goframewssvr bootstraps a dedicated goframe WebSocket server and
...
import (
	...
	"GS_PROJECT_MODULE/internal/api/server/goframewssvr/middleware"
