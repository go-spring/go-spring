// Package kitexthriftsvr bootstraps the Kitex/Thrift server and binds it to the
...
package kitexthriftsvr

import (
	"context"

	svc "GS_PROJECT_MODULE/idl/kitex-thrift/kitex_gen/svc"
	"GS_PROJECT_MODULE/internal/api/server/kitexthriftsvr/middleware"
