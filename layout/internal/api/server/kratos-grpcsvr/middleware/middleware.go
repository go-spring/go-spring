// Package middleware provides kratos-gRPC middleware (unary) for the kratos-gRPC server.
package middleware

import "context"

// UnaryInterceptor is the prototype for kratos-gRPC unary interceptors.
