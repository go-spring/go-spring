// Package kitex_grpcsvr bootstraps the Kitex gRPC/protobuf server and binds it
...
package kitex_grpcsvr

import (
	"context"

	svc "GS_PROJECT_MODULE/idl/kitex-grpc/kitex_gen/svc"
	"GS_PROJECT_MODULE/internal/api/server/kitex-grpcsvr/middleware"
