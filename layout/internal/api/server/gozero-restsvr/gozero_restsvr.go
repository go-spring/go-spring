// Package gozero_restsvr bootstraps a goctl-style HTTP server and binds it to the
// Go-Spring server lifecycle. The generated types + routes live under
// idl/gozero-rest; this file only owns the gs.Server adapter so the container
...
import (
	...
	"GS_PROJECT_MODULE/internal/api/server/gozero-restsvr/middleware"
