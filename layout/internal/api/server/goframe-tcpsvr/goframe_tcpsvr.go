// Package goframe_tcpsvr bootstraps a dedicated raw-TCP server and binds it to
...
import (
	...
	"GS_PROJECT_MODULE/internal/api/server/goframe-tcpsvr/middleware"
...
// shutdown logic; closing a net.Listener takes no context, so ctx is reserved
