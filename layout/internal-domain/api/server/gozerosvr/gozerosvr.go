...
// idl-domain/gozero; this file only owns the gs.Server adapter so the container
...
import (
	...
	"GS_PROJECT_MODULE/idl-domain/gozero/handler"
	"GS_PROJECT_MODULE/internal-domain/api/server/gozerosvr/middleware"
