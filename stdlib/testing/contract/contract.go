...
//     (typically a Task 01 declarative HTTP client — see go-spring.org/stdlib/httpx)
...
// stdlib's zero-dependency rule (mirroring go-spring.org/stdlib/i18n, which also
