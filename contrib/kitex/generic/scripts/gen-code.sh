...
# never imports the generated stubs — it parses idl/echo.thrift at runtime via
...
kitex -module go-spring.org/kitex/generic -gen-path idl -service echo idl/echo.thrift
