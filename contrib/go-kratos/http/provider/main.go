...
// contributed by starter-kratos/http, which publishes itself into etcd and
...
func main() {
	...
	// only server gs.Run() starts is the kratos HTTP transport from
	// starter-kratos/http, materialized because handler.go supplies a
