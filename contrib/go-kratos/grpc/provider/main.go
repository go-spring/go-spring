...
// contributed by starter-kratos/grpc, which publishes itself into etcd and
...
func main() {
	...
	// only server gs.Run() starts is the kratos gRPC transport from
	// starter-kratos/grpc, materialized because handler.go supplies a
