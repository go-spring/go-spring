...
# Everything here is therefore hand-written:
#
#   proto/greet.go          — WS frame payloads (JSON), the hand-written "IDL"
#   provider/handler.go     — upgrade + read/write loop, GreetLogic bean, route
#
...
# ../../greet-api/scripts/gen-code.sh, which does drive goctl, and
# ../../greet-rpc/scripts/gen-code.sh, which
