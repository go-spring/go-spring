...
// greethandler.go holds the HTTP entry-point functions that routes.go
// references. routes.go is regenerated from idl/greet.api on every idl/gen-code.sh run
...
func GreetHandler(svcCtx *ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req idl.GreetReq
