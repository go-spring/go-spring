...
// Package logic holds the business logic for each Greet endpoint. In a stock
// go-zero project this file is scaffolded by `goctl api go` and edited in
// place; here we replace the scaffold with a Go-Spring bean so the logic
// participates in DI just like every other Go-Spring component.
package logic
