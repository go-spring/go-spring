...
// (routes.go, greethandler.go) expects. Unlike the stock go-zero scaffold —
// which wires ServiceContext up in main() and passes it in — here it is a
// tiny bean whose fields are injected by Go-Spring.
package svc

import "greetapi/internal/logic"
