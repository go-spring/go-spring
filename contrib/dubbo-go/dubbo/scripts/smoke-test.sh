#!/usr/bin/env bash
#
# Smoke test for the dubbo-go classic (Hessian2) example, extended to exercise
...
wait_tcp 127.0.0.1 20001 || { echo "provider dubbo port not ready"; exit 1; }
...
# Capture stdout to assert on the echoed value — the dubbo consumer runs via
