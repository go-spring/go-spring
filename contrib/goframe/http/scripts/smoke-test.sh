#!/usr/bin/env bash
#
# Smoke test for the goframe registry example. Brings up a local etcd via
# docker compose, starts the provider (which registers goframe.hello into etcd),
...
# Start the provider; it registers into etcd and serves on :8000. Build to a
