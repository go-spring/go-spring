...
actions:
  - theme: brand
    text: 快速开始
    link: /docs/1.getting-started/getting-started
  - theme: alt
    text: 阅读指南
    link: /docs/2.guides/01-configuration
...
<section class="gs-section gs-cta">
  ...
  <div class="gs-actions">
    <a href="/docs/1.getting-started/getting-started">快速开始</a>
    <a href="/docs/3.examples/examples">查看示例</a>
  </div>
</section>
