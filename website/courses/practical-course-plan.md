...
建议以 `docs/3.examples/bookman` 为基础，设计一个“BookMan 进阶版”主线项目。它天然覆盖配置加载、Bean 注入、HTTP 路由、Controller、Service、DAO、SDK、动态配置、Runner、后台 Job 和测试，适合作为内容骨架。
...
- `docs/3.examples/examples.md` 目前还是 `todo`，建议后续整理成文章案例索引。
