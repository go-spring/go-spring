...
// logger later without touching framework wiring. The tag is shared across all
// dubbo-go protocols (triple / dubbo / jsonrpc / rest) so downstream filters do
// not have to distinguish sub-protocols.
