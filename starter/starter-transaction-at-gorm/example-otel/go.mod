module go-spring.org/starter-transaction-at-gorm/example-otel
...
require (
	...
	go-spring.org/starter-transaction-at-gorm v0.0.0-00010101000000-000000000000
...
replace go-spring.org/starter-transaction-at-gorm => ../
