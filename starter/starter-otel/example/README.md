...
- **Trace-Log correlation**: After creating a Span, logs carry `trace_id`/`span_id` - the example installs the `log.FieldsFromContext` hook itself (starter-otel no longer ships an installer for this seam)
