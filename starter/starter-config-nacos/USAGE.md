...
A service whose configuration lives in Nacos, with one hot-reloadable field. File tree
...
| "Watch out" entries | 5 (gRPC port, namespace-id, Dync-only, no endpoint/cluster, optional-swallows-wrong-group) |
