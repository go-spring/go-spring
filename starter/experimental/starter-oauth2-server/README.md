...
filter chain from ordinary `net/http` middleware in `cloud/experimental/security`
...
The unified Web-security filter chain lives in `cloud/experimental/security`. Compose the
