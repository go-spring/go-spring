...
exported as `health.Indicator` (from the zero-dependency `go-spring.org/cloud/actuator/health`
...
`go-spring.org/cloud/actuator/endpoint` package) is mounted on the management port, and
