module go-spring.org/starter-http-client/example-otel
...
require (
	...
	go-spring.org/starter-http-client v1.3.4
	go-spring.org/starter-http-client/example v0.0.0
...
replace go-spring.org/starter-http-client => ../
