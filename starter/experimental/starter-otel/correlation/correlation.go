...
// Package correlation wires trace ↔ log and trace ↔ discovery bridges.
// It is consumed by the top-level starter-otel package during setup,
// after the TracerProvider and propagator are installed as process globals.
package correlation
