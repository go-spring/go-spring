...
// is an OPTIONAL CONTAINER BEAN: a company or umbrella starter may provide its
// own Driver bean (its constructor returns StarterPulsar.Driver); when none is
// present, starter-pulsar falls back to the bundled [DefaultDriver] inside
