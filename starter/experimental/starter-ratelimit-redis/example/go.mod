module go-spring.org/starter-ratelimit-redis/example
...
require (
	...
	go-spring.org/starter-ratelimit-redis v0.0.0-00010101000000-000000000000
)
...
// Local, not-yet-published modules (resolved via the go.work workspace).
