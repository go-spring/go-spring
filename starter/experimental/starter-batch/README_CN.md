...
[`cloud/experimental/batch`](../../../cloud/experimental/batch) 定义的批处理任务——分块(chunk)长批与一次性
...
repository 全部来自零依赖的 [`cloud/experimental/batch`](../../../cloud/experimental/batch) 包;本 starter
