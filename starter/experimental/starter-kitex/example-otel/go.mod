module go-spring.org/starter-kitex/example-otel
...
require (
	...
	go-spring.org/starter-kitex v1.3.4
	go-spring.org/starter-kitex/example v0.0.0-00010101000000-000000000000
