module go-spring.org/starter-trpc/example-otel
...
require (
	...
	go-spring.org/starter-trpc v1.3.4
	go-spring.org/starter-trpc/example v0.0.0-00010101000000-000000000000
