module go-spring.org/starter-goframe/grpc/example-otel

go 1.26.1

require (
	go-spring.org/spring v1.3.4
	go-spring.org/starter-goframe v1.3.4
	go-spring.org/starter-goframe/grpc/example v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/gogf/gf/contrib/registry/etcd/v2 v2.10.2 // indirect
	github.com/gogf/gf/contrib/registry/file/v2 v2.10.2 // indirect
	github.com/gogf/gf/contrib/rpc/grpcx/v2 v2.10.2 // indirect
...
replace go-spring.org/starter-otel => ../../../../starter/starter-otel

replace go-spring.org/spring => ../../../../spring

replace go-spring.org/log => ../../../../log

replace go-spring.org/starter-actuator => ../../../../starter/starter-actuator
