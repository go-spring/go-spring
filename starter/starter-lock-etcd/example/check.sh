#!/usr/bin/env bash
#
# Smoke test for starter-lock-etcd. Brings up a single etcd node through
...
# Wait for etcd to accept client connections (up to 120s).
...
# Give etcd a moment to finish booting after the port opens.
sleep 2
