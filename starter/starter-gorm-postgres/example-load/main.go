...
// Package main is the load-test binary for starter-gorm-postgres. It wires a
// gorm PostgreSQL client (resilience + fault hot-reloadable) and drives SELECT 1
...
type Service struct {
	DB *gormcore.DB `autowire:"postgres.load"`
}
