...
// Command example is a flagship for starter-gorm-postgres that composes the cloud-
...
func init() {
	...
	// The DB client resolves "postgres-cluster" through this "default" backend.
	gs.Provide(func() (discovery.Discovery, error) {
		return discovery.NewStaticDiscovery(discovery.Endpoint{Addr: "127.0.0.1:5432", Healthy: true}), nil
	}).Name("default")
}
