...
// Package main is the load-test binary for starter-memcached. It wires a
// Memcached client (resilience + fault hot-reloadable) and drives SET/GET
// through the shared [loadtest] harness, printing throughput / latency /
...
type Service struct {
	Memcached *StarterMemcached.Client `autowire:"load"`
}
