module go-spring.org/starter-transaction-tcc/example-otel

go 1.26.1

require (
	go-spring.org/log v1.3.4
	go-spring.org/spring v1.3.4
	go-spring.org/starter-otel v1.3.4
	go-spring.org/starter-transaction-tcc v1.3.4
)
...
replace go-spring.org/starter-transaction-tcc => ../
