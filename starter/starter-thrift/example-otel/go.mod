module go-spring.org/starter-thrift/example-otel
...
require (
	...
	go-spring.org/starter-thrift v1.3.4
	go-spring.org/starter-thrift/example v0.0.0-00010101000000-000000000000
)
...
replace go-spring.org/starter-thrift => ../
