#!/usr/bin/env bash
#
# Smoke test for starter-mqtt. Brings up a local MQTT broker (mosquitto) via
...
# Wait for the broker to accept MQTT connections (up to 60s).
...
# Give the broker a moment to finish booting after the port opens.
sleep 2
