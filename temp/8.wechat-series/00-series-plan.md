...
本文档用于指导后续把 `cn/2.guides` 中的内容拆分并改写为公众号系列文章。

当前规划为 **30 篇能力主题文章 + 1 篇整体说明文章**，共 31 篇。系列定位不是零基础入门文，而是面向已经熟悉 Go 工程开发、希望系统理解 go-spring 能力边界和设计取舍的读者。

`cn/2.guides/08-http-gen.md` 暂不纳入本系列。

## 写作原则

1. 尽量复用 `cn/2.guides` 的原文、示例代码和术语，只做必要润色。
...
- `cn/2.guides/01-configuration.md:1-47`
...
- `cn/2.guides/01-configuration.md:48-87`
- `cn/2.guides/01-configuration.md:246-283`
...
- `cn/2.guides/01-configuration.md:88-245`
...
- `cn/2.guides/01-configuration.md:284-400`
...
- `cn/2.guides/01-configuration.md:401-598`
...
- `cn/2.guides/01-configuration.md:599-690`
...
- `cn/2.guides/01-configuration.md:691-781`
...
- `cn/2.guides/01-configuration.md:782-886`
- `cn/2.guides/03-app-start-stop.md:519-549`
...
- `cn/2.guides/02-ioc-container.md:1-163`
...
- `cn/2.guides/02-ioc-container.md:164-226`
...
- `cn/2.guides/02-ioc-container.md:227-515`
...
- `cn/2.guides/02-ioc-container.md:516-878`
...
- `cn/2.guides/02-ioc-container.md:879-1160`
...
- `cn/2.guides/02-ioc-container.md:1161-1386`
...
- `cn/2.guides/02-ioc-container.md:1387-1574`
...
- `cn/2.guides/02-ioc-container.md:1592-1698`
...
- `cn/2.guides/03-app-start-stop.md:1-88`
- `cn/2.guides/03-app-start-stop.md:178-402`
- `cn/2.guides/03-app-start-stop.md:404-491`
...
- `cn/2.guides/03-app-start-stop.md:8-176`
- `cn/2.guides/03-app-start-stop.md:404-549`
- `cn/2.guides/01-configuration.md:843-886`
...
- `cn/2.guides/04-logging.md:1-361`
...
- `cn/2.guides/04-logging.md:362-499`
...
- `cn/2.guides/04-logging.md:500-800`
...
- `cn/2.guides/04-logging.md:801-1114`
...
- `cn/2.guides/04-logging.md:1115-1262`
...
- `cn/2.guides/04-logging.md:1263-1550`
...
- `cn/2.guides/04-logging.md:700-1105`
- `cn/2.guides/04-logging.md:1360-1545`
...
- `cn/2.guides/04-logging.md:1550-1812`
...
- `cn/2.guides/05-http-server.md:1-300`
...
- `cn/2.guides/06-components.md:1-177`
- `cn/2.guides/02-ioc-container.md:1161-1386`
...
- `cn/2.guides/07-testing.md:1-214`
- `cn/2.guides/02-ioc-container.md:1819-1827`
...
- `cn/2.guides/07-testing.md:215-403`
